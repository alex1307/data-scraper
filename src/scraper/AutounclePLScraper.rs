...
#[derive(Debug, Clone)]
pub struct AutounclePLScraper {
    pub parent: Scraper,
}

impl AutounclePLScraper {
    pub fn new(url: &str, wait_time_ms: u64) -> Self {
        AutounclePLScraper {
            parent: Scraper::new(
                url,
                "page".to_string(),
                "autouncle.pl".to_string(),
                wait_time_ms,
            ),
        }
    }
...
#[async_trait]
impl ScrapeListTrait<CarData> for AutounclePLScraper {
...
#[async_trait]
impl ScraperTrait for AutounclePLScraper {
...
mod autouncle_test {
    ...
    use crate::{LOG_CONFIG, constants::URL::AUTOUNCLE_PL_URL, utils::helpers::configure_log4rs};
    ...
    fn test_get_number_of_pages() {
        ...
        let autouncle = AutounclePLScraper::new(AUTOUNCLE_PL_URL, 0);
