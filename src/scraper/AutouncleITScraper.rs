...
#[derive(Debug, Clone)]
pub struct AutouncleITScraper {
    pub parent: Scraper,
}

impl AutouncleITScraper {
    pub fn new(url: &str, wait_time_ms: u64) -> Self {
        AutouncleITScraper {
            parent: Scraper::new(
                url,
                "page".to_string(),
                "autouncle.it".to_string(),
                wait_time_ms,
            ),
        }
    }
...
#[async_trait]
impl ScrapeListTrait<CarData> for AutouncleITScraper {
...
#[async_trait]
impl ScraperTrait for AutouncleITScraper {
...
mod autouncle_test {
    ...
    use crate::{LOG_CONFIG, constants::URL::AUTOUNCLE_IT_URL, utils::helpers::configure_log4rs};
    ...
    fn test_get_number_of_pages() {
        ...
        let autouncle = AutouncleITScraper::new(AUTOUNCLE_IT_URL, 0);
